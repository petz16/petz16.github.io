...
* **Project Idea:** Develop a **Pitcher Profile Clustering Model** (e.g., using K-Means) to categorize pitchers based on their percentile ranks. This could identify elite **"Strikeout Artists"** (high<span title="Strikeout Percentage. The number of strikeouts divided by the number of plate appearances.">**K%**</span>, high 
